...
op_newNoise = 1; % 0 existing noise_feat; 1 new generated noise_feat
record_noise = 1;
...
%     end
    for j = 1:M
        ...
        d_local_feature{j}(1:3, i) = [0;0;0];%deform{ceil(j/M*M_all)}(1:3, i_trans);
...
if record == 1
    ...
    save(['result/EKF' num2str(op) num2str(op_trans) num2str(op_noise) '.mat'], 'u', 'traceP', 'num_unseen',...
        'er2', 'ef2', 'e2', 'erP2', 'efP2', 'eP2', 'traceP_all', 'step_vis', 't');
